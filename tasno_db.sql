...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2016 at 05:11 PM
...
(62, '10 تا 20 هزار تومان', '', '', 0, 'price', 0, '', 0, 1),
(63, '20 تا 50 هزار تومان', '', '', 0, 'price', 0, '', 0, 1),
(64, 'تست', '', '', 0, 'cat', 0, 'data/cat/cat/0-1465977259-0-1465806927-WS00221.jpg', 0, 1),
(65, 'تست2', '', '', 0, 'cat', 0, 'data/cat/cat/0-1465977293-martinus-view-black.jpg', 0, 1),
(66, 'تست2', '', '', 0, 'cat', 0, '', 1, 1),
...
(1, 'تست', 'taghipoor.meysam@gmail.com', '09119026756', 'taghipoor.meysam@gmail.com', 'تست', 1466104250, 0),
(2, 's', 'taghipoor.meysam@gmail.com', '2', 'taghipoor.meysam@gmail.com', '2', 1466105563, 0),
(3, 'w', 'taghipoor.meysam@gmail.com', '2', 'taghipoor.meysam@gmail.com', '4', 1466106647, 0);
...
(25, 26, 'meysam', 'sam', '01', '9', 5, 'mtaghipoor13@gmail.com', 'i', 1465908043),
(26, 27, 'ف', 'ف', '4', '4', 4, 'taghipoor.meysam@gmail.com', '4', 1466111727);
...
(23, 9, 'تیشرت  تبلیغاتی  آستین کوتاه', '2705', 'M-L-XL-XXL', 'دیجیتال ، گلدوزی', 200, 62, 'data/product_photo_medium/23/0-1465805885-mardane-yaghe-gerd---s.jpg', 'data/product_photos_large/23/0-1465805453-mardaneyaghegerd.jpg', 'تیشرت آستین کوتاه مردانه یقه گرد ، امکان تولید در رنگهای اختصاصی\r\nامکان گلدوزی و چاپ طرح شما بدون محدودیت رنگ و سایز\r\nدر سایز های مختلف', 0, 1),
(24, 19, 'کلاه نقابدار تبلیغاتی', '5474', 'بزرگسال', 'دیجیتال ، گلدوزی', 200, 63, 'data/product_photo_medium/24/0-1465806427-cap--s.jpg', 'data/product_photos_large/24/0-1465806427-cap.jpg', 'کلاه تبلیغاتی نقابدار ، در رنگ های مختلف ، جنس کتان ، درجه یک\r\nامکان چاپ و گلدوزی طرح شما بدون محدودیت سایز و رنگ', 0, 1),
(25, 19, 'سایبان تبلیغاتی', '5487', 'بزرگسال', 'دیجیتال ، گلدوزی', 200, 62, 'data/product_photo_medium/25/0-1465806562-sayeban--s.jpg', 'data/product_photos_large/25/0-1465806562-sayeban.jpg', 'سایبان زنانه تبلیغاتی ، جنس کتان ، در رنگ های مختلف\r\nامکان چاپ و گادوزی طرح شما بدون محدودیت سایز و رنگ', 0, 1),
(26, 21, 'جاکلیدی تبلیغاتی', 'ws0022', '', 'لیزر - ژله ای', 200, 63, 'data/product_photo_medium/26/0-1465806927-WS0022.jpg', 'data/product_photos_large/26/0-1465806927-WS0022.jpg', '', 0, 1),
(27, 0, 'خودکار تبلیغاتی', 'NEXT', '', 'تامپو', 200, 63, 'data/product_photo_medium/27/0-1465807279-nextc-s.jpg', 'data/product_photos_large/27/0-1465807279-nextc.jpg', '', 0, 1);
...
(12, 'ایرانسل', 'data/project_image/12/0-1465732914-1.jpg', 'توب فومی تبلیغاتی  ، به سفارش ایرانسل ، آبان ماه 1394', 3, 1),
(13, 'بانک ملت', 'data/project_image/13/0-1465733033-5.jpg', 'جاکلیدی چرم ، با جعبه اختصاصی ، به سفارش یاس ، خرداد 1390', 1, 1),
(14, 'جا یادداشتی', 'data/project_image/14/0-1465733189-6.jpg', 'جا یادداشتی ، به سفارش داتک ، اردیبهشت 1392', 2, 1),
(15, 'خودکار تبلیغاتی', 'data/project_image/15/0-1465733298-8.jpg', 'خودکار تبلیغاتی ، جعبه اختصاصی ، به سفارش پارس کامتل ، اردیبهشت 1390', 4, 1),
(16, 'جاکلیدی تبلیغاتی', 'data/project_image/16/0-1465733460-total2.jpg', 'جاکلیدی تبلیغاتی ، به سفارش توتال ، اسفند 1393', 5, 1),
(17, 'درب بازکن', 'data/project_image/17/0-1465733538-shams.jpg', 'درب بازکن بطری تبلیغاتی ، به سفارش کاسل توش ، اسفند 1394', 6, 1),
(18, 'پیکسل تبلیغاتی', 'data/project_image/18/0-1465733629-13.jpg', 'پیکسل تبلیغاتی ، به سفارش لگوی آموزشی ، بهمن 1391', 7, 1),
(19, 'تبشرت تبلیغاتی', 'data/project_image/19/0-1465733696-rightel3.jpg', 'تیشرت تبلیغاتی ، به سفارش رایتل ، شهریور 1393', 8, 1),
(20, 'بح سینه', 'data/project_image/20/0-1465733785-aval.jpg', 'بج سینه اختصاصی ، به سفارش خدمات اول مبین ، مرداد 1393', 9, 1),
(21, 'پد موس تبلیغاتی', 'data/project_image/21/0-1465733915-18.jpg', 'پد موس ، به سفارش کیش بهین ، فروردین 1391', 10, 1),
(22, 'کلاه تبلیغاتی', 'data/project_image/22/0-1465733999-butan.jpg', 'کلاه تبلیغاتی ، به سفارش بوتان ، اردیبهشت 1395', 11, 1),
(23, 'ملگ سرامیکی تبلیغاتی', 'data/project_image/23/0-1465734089-pishpish.jpg', 'ماگ سرامیکی ، به سفارش پیشگامان کویر یزد ، تیرماه 1393', 12, 1),
(24, 'بند آویز', 'data/project_image/24/0-1465734203-19.jpg', 'بند گردنی ، به سفارش گلدیران ، مهرماه 1391', 13, 1),
(25, 'پاور بانک تبلیغاتی', 'data/project_image/25/0-1465734298-total1.jpg', 'پاور بانک ، به سفارش توتال ، اردیبهشت 1394', 14, 1),
(26, 'ست تبلیغاتی', 'data/project_image/26/0-1465734435-4.jpg', 'ست جعبه چوبی تبلیغاتی ، به سفارش ایرانسل ، مهرماه 1391', 15, 1),
(27, 'پد موس تبلیغاتی', 'data/project_image/27/0-1465734489-15.jpg', 'پد موس تبلیغاتی ، به سقارش بانک ملت ، خرداد 1390', 16, 1),
(28, 'خودکار تبلیغاتی', 'data/project_image/28/0-1465734573-20.jpg', 'خودکار پلاستیکی تبلیغاتی ، به سفارش راد سیستم ، آذر 1391', 17, 1),
(29, 'ملگ سرامیکی تبلیغاتی', 'data/project_image/29/0-1465734674-21.jpg', 'ماگ سرامیکی ، به سفارش خیره بهنام دهش پور ،  تیر 1392', 18, 1),
(30, 'عروسک تبلیغاتی', 'data/project_image/30/0-1465734770-righteltoys.jpg', 'عروسک فومی ، به سفارش رایتل ، خانواده دکا ، 1394', 19, 1),
(31, 'بند پرسنلی', 'data/project_image/31/0-1465734857-renult.jpg', 'بند آویز پرسنل ، به سفارش رنو پارس ، مرداد 1393', 20, 1),
(32, 'آفتابگیر تبلیغاتی', 'data/project_image/32/0-1465734967-rightelsunshade.jpg', 'آفتابگیر اتومبیل ، به سفارش رایتل ، تیر 1394', 21, 1),
(33, 'پد موس طبی تبلیغاتی', 'data/project_image/33/0-1465735051-mellatchap.jpg', 'پد موس طبی ، به سفارش چاپخانه بانک ملت ، اسفند 1393', 22, 1),
(34, 'لیوان تبلیغاتی', 'data/project_image/34/0-1465735175-nak2.jpg', 'لیوان یخی بلور ، به سفارش نقش اول ، بهمن 1394', 23, 1),
(35, 'فولدر تبلیغاتی', 'data/project_image/35/0-1465735243-kelasor.jpg', 'کلاسور تبلیغاتی اختصاصی ، به سفارش ایرانسل ، تیرماه 1394', 24, 1),
(36, 'پد موس تبلیغاتی', 'data/project_image/36/0-1465735319-16.jpg', 'موس پد تبلیغاتی ، به سفارش بانک انصار ، فروردین 1392', 25, 1),
(37, 'بند گردنی', 'data/project_image/37/0-1465735398-2.jpg', 'بند و محافط کارت ، سفارش شرکت ایرانسل ، مرداد 1393', 26, 1),
(38, 'پیکسل تبلیغاتی', 'data/project_image/38/0-1465735897-14.jpg', 'پیکسل تبلیغاتی ، به سفارش رستوران البیک ، 1393', 27, 1),
(39, 'پد موس تبلیغاتی', 'data/project_image/39/0-1465735854-17.jpg', 'پد موس پارچه ای ، به سفارش موسسه علوم و فنون کیش ، 1390', 28, 1),
(40, 'ماگ', 'data/project_image/40/0-1465736008-24.jpg', 'ماگ تبلیغاتی ، به سفارش مادیران ، 1390', 29, 1),
(41, 'پد موس تبلیغاتی', 'data/project_image/41/0-1465736066-26.jpg', 'پد موس ، به سفارش بانک صادرات سمنان ، دی ماه 1393', 30, 1),
(42, 'جاکلیدی تبلیغاتی', 'data/project_image/42/0-1465736143-irancellkeyring.jpg', 'جاکلیدی اختصاصی به سفارش ایرانسل ، آبان 1394', 31, 1),
(43, 'کلاه ایمینی تبلیغاتی', 'data/project_image/43/0-1465736210-total.jpg', 'کلاه ایمنی تبلیغاتی ، به سفارش توتال ، فروردین 1394', 32, 1),
(44, 'جعبه هدایا', 'data/project_image/44/0-1465736477-rightel2.jpg', 'جعبه اختصاصی ویژه مسابقات جام جهانی 2014 ، به سفارش رایتل ، تیرماه 1393', 33, 1),
(45, 'کیف لوازم آرایش تبلیغاتی', 'data/project_image/45/0-1465736582-kale.jpg', 'کیف لوازم آرایش ، تولید شده به سفارش کاله ، شهریور 1392', 34, 1),
(46, 'دفترچه تبلیغاتی', 'data/project_image/46/0-1465736655-bazar.jpg', 'دفترچه ، بج و لیوان تبلیغاتی ، به سفارش کافه بازار ، بهمن 1393', 35, 1),
(47, 'ماگ تبلیغی', 'data/project_image/47/0-1465736730-notrino.jpg', 'ماگ تبلیغاتی، به سفارش همراه اول ، نمایشگاه الکامپ 1393', 36, 1),
(48, 'دستمال کاغذی تبلیغاتی', 'data/project_image/48/0-1465737106-farahi.jpg', 'دستمال کاغذی تبلیغاتی ، اختصاصی ، به سفارش فرش فرهی ، شهریور 1393', 37, 1),
(49, 'ماگ تبلیغاتی', 'data/project_image/49/0-1465737210-irancellmug.jpg', 'ماگ تبلیغاتی ، به سفارش ایرانسل ،  نمایشگاه الکامپ  1394', 38, 1),
(50, 'تبشرت تبلیغاتی', 'data/project_image/50/0-1465737313-legoo.jpg', 'پیراهن تیم ملی روباتیک ایران ، به سفارش لگوی آموزشی ، شهریور 1394', 39, 1),
(51, 'بند همایشی', 'data/project_image/51/0-1465737389-eye.jpg', 'بند آویز و محافط کارت ، همایش چشم پزشکی ، به سفارش هویا ، مرداد 1393', 40, 1),
(52, 'خودنویس تبلیغاتی', 'data/project_image/52/0-1465737496-isim.jpg', 'خودکار و خودنویس تبلیغاتی ، پروژه آی سیم ، به سفارش ایرانسل ، اسفند 1394', 41, 1),
(53, 'بند گردنی تبلیغاتی', 'data/project_image/53/0-1465737593-rightel.jpg', 'بند گردن پرسنلی ، به سفارش رایتل ، دی ماه 1393', 42, 1),
(54, 'دستبند تبلیغاتی', 'data/project_image/54/0-1465737692-rexona.jpg', 'دستبندتبلیغاتی ، رکسونا ، اردیبهشت 1394', 43, 1),
(55, 'دفترچه چرم تبلیغاتی', 'data/project_image/55/0-1465737749-mobinnet.jpg', 'دفترچه چرم تبلیغاتی ، به سفارش مبین نت ، خرداد 1394', 44, 1),
(56, 'ماگ یخی تبلیغاتی', 'data/project_image/56/0-1465737815-pril.jpg', 'لیوان برفکی تبلیغاتی ، به سفارش پریل ، مرداد 1394', 45, 1),
(57, 'آفتابگیر تبلیغاتی', 'data/project_image/57/0-1465737890-datakaft.jpg', 'آفتابگیر تبلیغاتی ، تمام رنگی ، به سفارش داتک تلکام ، مهرماه 1394', 46, 1),
(58, 'ماگ تبلیغاتی', 'data/project_image/58/0-1465738006-hype.jpg', 'ماگ سرامیکی ، به سفارش هایپ ، بهمن 1394', 47, 1),
(59, 'سجاده تبلیغاتی', 'data/project_image/59/0-1465738083-righteljanamaz.jpg', 'جانماز مسافرتی ، به سفارش رایتل ، مهرماه 1394', 48, 1),
(60, 'پد موبایل', 'data/project_image/60/0-1465738195-nakpad.jpg', 'پد موبایل ، به سفارش نقش اول کیفیت ، اسفند 1394', 49, 1),
(61, 'حوله تبلیغاتی', 'data/project_image/61/0-1465738302-mitkish.jpg', 'حوله دستی تبلیغاتی ،به سفارش میتا کیش ، بهمن 1394', 50, 1),
(62, 'تیشرت تبلیغاتی', 'data/project_image/62/0-1465738367-lamiz.jpg', 'تیشرت اختصاصی ، به سفارش لمیز کافی ، اسفند 1393', 51, 1),
(63, 'لیوان دسته رنگی', 'data/project_image/63/0-1465738431-mci.jpg', 'لیوان دسته رنگی ، به سفارش همراه اول ، اسفند 1394', 52, 1);
...
('contact_email_address_0', '', '11info@tasvireno.com', ''),
...
('contact_email_address_1', '', 'taghipoor.meysam@gmail.com', '');
...
(10, 'کاتالوگ محصول1', 67, 'http://sam.bluewhale.ir/', 'کاتالوگ محصول', 'data/slideshow/0-1466243664-4545-FeatureBanner-selfiesticks.jpg'),
(11, '1', 68, 'http://sam.bluewhale.ir/', 'پروژه انجام شده', 'data/slideshow_pic/11/0-1466260170-google-seo.jpg'),
(12, 'jsj', 68, 'https://www.youtube.com/watch?v=woSM8VTgjBg&index=28&list=PL3Y-E4YSE4wYWg9eXKMT9y0bJKbhOWT0B', 'dd', 'data/slideshow_pic/12/0-1466260654-pencils-5.jpg');
...
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'شناسه سفارش', AUTO_INCREMENT=27;
--
